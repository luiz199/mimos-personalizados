...
export function getPlaceholderColors(subcategory?: string): [string, string, string] {
...
export function generatePlaceholder(name: string, subcategory?: string): string {
  const [c1, c2, c3] = getPlaceholderColors(subcategory);
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300" viewBox="0 0 400 300">
    ...
    <text x="200" y="145" text-anchor="middle" font-family="system-ui, sans-serif" font-size="60" font-weight="300" fill="rgba(255,255,255,0.7)">${initial}</text>
    <text x="200" y="220" text-anchor="middle" font-family="system-ui, sans-serif" font-size="14" font-weight="400" fill="rgba(255,255,255,0.5)">${displayName}</text>
  </svg>`;
  try {
